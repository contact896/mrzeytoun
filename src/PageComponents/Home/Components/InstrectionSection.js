...
import {
  ...
  HOW_TO_USE_GUIDE2,
  HOW_TO_USE_GUIDE3,
  HOW_TO_USE_SPRAY_GUIDE1,
  HOW_TO_USE_SPRAY_GUIDE2,
  HOW_TO_USE_SPRAY_GUIDE3,
} from "@/Constant/image";
...
export default function InstrectionSection() {
  ...
  const stepsForSpray = [
    {
      id: 1,
      icon: HOW_TO_USE_SPRAY_GUIDE1,
      title: "Spray",
      description: "Apply evenly to dry or slightly damp hair from a distance.",
      note: "Start with a few sprays and build as needed for your desired texture.",
    },
    {
      id: 2,
      icon: HOW_TO_USE_SPRAY_GUIDE2,
      title: "Scrunch",
      description: "Use your hands to scrunch and shape your hair.",
      note: " This helps enhance natural movement and creates effortless texture.",
    },
    {
      id: 3,
      ...
      note: " Use your fingers to refine the look and achieve a relaxed, textured style.",
    },
  ];
  const [animationType, setAnimationType] = useState("fade-right");
  const [btnType, setBtnType] = useState("MatteClay");
    ...
    <section className="py-16 md:py-24 bg-white custom-container">
      <div className="">
        ...
        <div className="mb-4 flex flex-col md:flex-row md:justify-between">
          <div className="mb-4">
            ...
            >
              ...
              <br />
              Here's how to get the best out of your MR ZEYTOUN{" "}
              {btnType === "MatteClay" ? "Matte Clay" : "Sea Salt Spray"}.
            </p>
          </div>
          <div className="mb-4 md:mb-0">
            <button
              className={`rounded-full px-4 py-2 cursor-pointer ${btnType == "MatteClay" ? "bg-black text-white" : "bg-white text-black border border-black"}`}
              type="button"
              onClick={handleClick("MatteClay")}
            >
              Matte Clay
            </button>
            <button
              className={`rounded-full px-4 py-2 cursor-pointer md:ml-2 ${btnType == "SeaSaltSpray" ? "bg-black text-white" : "bg-white text-black border border-black"}`}
              type="button"
              onClick={handleClick("SeaSaltSpray")}
            >
              Sea Salt Spray
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 justify-between gap-2.5 md:gap-6 mb-12">
          {(btnType === "MatteClay" ? steps : stepsForSpray).map(
            (step, index) => (
        ...
        <div className="text-center max-w-3xl mx-auto">
          <p className="text-sm md:text-base text-gray-600 font-medium">
            {btnType === "MatteClay"
              ...
              : "For best results, shake well before use and avoid over-saturating your hair for a natural, airy finish."}
          </p>
        </div>
      </div>
    </section>
